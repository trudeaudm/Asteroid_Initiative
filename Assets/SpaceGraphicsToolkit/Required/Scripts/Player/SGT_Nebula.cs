...
public class SGT_Nebula : SGT_MonoBehaviourUnique<SGT_Nebula>
{
	...
	[SerializeField]
	private Color particleSideColour = Color.white;
	
	[SerializeField]
	private Color particleTopColour = Color.white;
	...
	[SerializeField]
	private Quaternion nebulaCameraRotation;
	
	[SerializeField]
	private float nebulaCameraRoll;
	...
	public Color ParticleSideColour
	{
		set
		{
			particleSideColour = value;
		}
		
		get
		{
			return particleSideColour;
		}
	}
	
	public Color ParticleTopColour
	{
		set
		{
			particleTopColour = value;
		}
		
		get
		{
			return particleTopColour;
		}
	}
	...
	private void Validate()
	{
		...
		if (nebulaCamera   == null) NebulaCamera   = SGT_Helper.FindCamera(); // NOTE: Assigning property
		...
		var oldCameraRotation   = nebulaCameraRotation; if (nebulaCamera != null) nebulaCameraRotation = nebulaCamera.transform.rotation;
